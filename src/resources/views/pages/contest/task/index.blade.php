...
<div class="flex">
    ...
    <!-- Right part -->
    <form id="solution-form" class="flex flex-col w-1/2 h-[70vh] p-6" action="{{ route('contest.task.submit', ['contest' => $contest->id, 'task' => $task->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="relative w-full">
            ...
            <button id="fullscreen-btn" type="button"
                class="fullscreen-icon group absolute top-2 right-2 z-10"
                aria-label="Полноэкранный режим">
                <svg id="fullscreen-enter" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 block" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2">
            ...
            <button id="fullscreen-exit" type="button"
